# -*- encoding: utf-8 -*-
# stub: google_drive 2.1.9 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<google-api-client>.freeze, ["< 0.20.0", ">= 0.11.0"])
      ...
      s.add_dependency(%q<google-api-client>.freeze, ["< 0.20.0", ">= 0.11.0"])
