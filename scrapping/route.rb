...
def get_the_email_of_a_townhal_from_its_webpage(temporaire, nb, feuillu)
...
def get_all_the_urls_of_val_doise_townhalls(liens,feuille)                                  #creation du tableau
...
url.each do |urle|
  get_all_the_urls_of_val_doise_townhalls(urle,sheet)
  sheet.save
end
